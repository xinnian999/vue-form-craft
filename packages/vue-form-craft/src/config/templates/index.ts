...
export default [
  {
    ...
    children: [
      ...
      { label: '登录', schema: login, description: '常见的《登录》表单，包含用户名、密码与“记住我”。' },
      { label: '用户信息', schema: userProfile, description: '用户基本信息表单：姓名、性别、生日、邮箱、手机号等。' },
      { label: '搜索筛选', schema: searchFilter, description: '常见的搜索筛选表单：关键词、分类、时间范围、状态。' },
      { label: '地址与联系人', schema: addressContact, description: '省市选择联动、详细地址、联系人、联系电话等。' },
      { label: '订单与发票', schema: orderInvoice, description: '订单信息与发票申请表单，包含公司发票的条件显示与校验。' },
      { label: '附件上传', schema: fileUpload, description: '多文件上传表单，限制格式与数量，并含说明。' },
      { label: '日期区间与预约', schema: dateRangeBooking, description: '预约时间段选择、人数、备注等常见场景。' }
    ]
  },
  {
    label: '表单联动案例',
